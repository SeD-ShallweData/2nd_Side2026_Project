...
- The exact Hanbit question and the neutral wage-card question produced a useful final response in six repeated local integration calls. All six raw Upstage generations still needed guardrail replacement, so this is final-response success rather than raw-model success.
