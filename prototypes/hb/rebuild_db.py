...
LAWS = [
    ...
    # 아래 둘은 '돈과 직결된 것부터 좁게' 기준으로 추가. 실업급여·육아휴직 급여는
    # 사용자가 실제로 자주 묻는데 답할 근거가 없어 오답이 나던 영역이다.
    # 추가한 뒤에는 bot.OUT_OF_SCOPE_TOPICS에서 해당 주제를 빼야 한다.
    {"name": "고용보험법", "mst": "279807", "code": "emp"},
    {"name": "남녀고용평등과 일ㆍ가정 양립 지원에 관한 법률", "mst": "276851", "code": "eeo"},
]
